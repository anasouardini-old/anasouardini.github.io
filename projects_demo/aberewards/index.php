...
if (isset($_GET['submit'])){
 ...
 $subject = "AUSRewards Client";
 $headers = "From: AUSRewards \r\n From : ".$email."\r\n Name : ".$firstName." ".$lastName."\r\nMessage : ".$message;
 if(mail($mailTo, $subject, $headers)){
     echo "<div class='alert sent' ><p> Email Sent </p></div>";
   }
   else{
     echo "<div class='alert failed' ><p> Email Sending Failed </p></div>";
   }  
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="menu_overlay" id="menuOverlay">
        <div class="menu_objects"><a href="#howItWorks">
                <h4>How It Works</h4>
            </a><a href="https://www.thanksagain.com/airport-details?code=AUS">
                <h4>Locations</h4>
            </a><a href="#contactUs">
                <h4>Contact Us</h4>
    ...
    <div class="hero">
        <div class="thanks">
            <div class="container">
                <h1>Announcing AUS Rewards powered by Thanks Again <span>&reg</span></h1>
                <p>Thanks Again enables you to earn valuable rewards when you shop, park and dine at AUS as well as over 100 other airports (and beyond)!</p>
            </div>
        </div>
        <div class="overlay">
            <div class="container">
                <h2>Enroll Today And Earn 100 Bonus Points!*</h2><a href="https://www.thanksagain.com/member-enrollment?source=AUS"><button>Register Now!</button></a>
            </div>
            <div class="info">
            ...
            <div class="stepsContainer">
                <div class="register">
                    ...
                    <div class="content">
                        ...
                        <p>That’s why we’ve made earning points with AUSRewards is refreshingly simple.</p><a href="https://www.thanksagain.com/member-enrollment?source=AUS"><button>Register Now!</button></a>
                    </div>
                </div>
                <div class="enroll">
        ...
        <div class="container">
            ...
            <div class="divsContainer">
                ...
                <div class="parking">
                    ...
                    <div class="content">
                        <p>Get 2x Thanks Again points for parking with ABIA Park with Ease.</p>
                    </div>
                </div>
                <div class="shopping">
                    ...
                    <div class="content">
                        <p>Be rewarded when you shop at AUS.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="signUp">
        <h2>Sign Up</h2>
        <p>Ready to earn some points?</p><a href="https://www.thanksagain.com/member-enrollment?source=AUS"><button>Register Now!</button></a>
    </section>
    ...
    <section class="footer">
        <div class="container">
            ...
            <p>&copy Copyright 2019, Austin-Bergstrom International Airport</p>
        </div>
    </section>
